...
describe("Daily digest (US4)", () => {
  ...
  it("T060: getDailyDigest returns correct metrics including pending approvals", () => {
    // Completed tasks
    queue.push({ id: "a", taskType: "review", title: "A", description: "D", source: "s1", priority: 5, dependsOn: null, parentTaskId: null, repo: null });
    queue.push({ id: "b", taskType: "fix", title: "B", description: "D", source: "s2", priority: 5, dependsOn: null, parentTaskId: null, repo: null });
    ...
    // Failed task
    queue.push({ id: "c", taskType: "build", title: "C", description: "D", source: "s3", priority: 5, dependsOn: null, parentTaskId: null, repo: null });
    queue.updateStatus("c", "in_progress");
    queue.updateStatus("c", "failed");

    // Awaiting approval task
    queue.push({ id: "d", taskType: "review", title: "D", description: "D", source: "s4", priority: 5, dependsOn: null, parentTaskId: null, repo: null });
